                ...
                <div class="py-2">
                    <div class="">
                        <div class="bg-white p-2 overflow-hidden">
                            <p class="text-center text-sm">I'm sorry, the user wasn't created because:</p>
                ...
                <div class="border border-gray-200 p-8 w-1/4">
                    <form method="post" action="/admin/users">
                        ...
                        <div class="mt-4 text-sm">
                            <x-label for="displayname" value="Display Name" />
                            <x-input id="displayname" class="block mt-2 w-full" type="text" name="displayname" :value="old('displayname')" required autofocus autocomplete="name" />
                        </div>
                        <div class="mt-4 text-sm">
                    ...
                    <table class="table table-striped border border-gray-200">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="text-sm"><a href="mailto:{{ $user->email }}">{{ $user->email }}</a></td>
                                <td class="text-sm">{{ $user->created_at }}</td>
                                <td class="text-sm">{{ $user->updated_at }}</td>
                                <td class="">
                                    <div class="flex justify-between">
                                        <a href="{{ url('admin/users/'.$user->id.'/edit') }}" class="text-orange-400 hover:text-orange-200">
                                        ...
                                        <a href="{{ url('admin/users/'.$user->id) }}" class="text-blue-400 hover:text-blue-200">
