        ...
        <div class="flex items-center justify-center">
            <div class="border border-gray-200 p-8 w-1/4">
                <form method="post" action="/admin/roles">
                    @csrf
                    <div class="text-sm">
                        <x-label for="role" value="Name of the role" />
                        <x-input id="role" class="block mt-2 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="role" />
                    </div>
                    <div class="flex items-center justify-center mt-8">
                        <x-button type="submit"> Create new role </x-button>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-between">
                                    <a href="{{ url('admin/roles/'.$role->id.'/edit') }}" class="inline-flex items-baseline text-orange-400 hover:text-orange-200">
                                    ...
                                    <a href="{{ url('admin/roles/'.$role->id) }}" class="text-blue-400 hover:text-blue-200">
