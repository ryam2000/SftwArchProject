...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 overflow-hidden">
            <div name="logo">
                <img class="block h-16 w-auto text-center" src="/img/humminglogo.png" alt="Hummingbird">
            </div>
            <p class="text-center text-lg">Welcome to <b>Hummingbird</b>!</p>
        </div>
        @if (Route::has('login'))
            <div class="hidden items-center px-6 py-4 sm:block">
                ...
                @else
                    ...
                    <a href="{{ url('/home') }}" class="ml-4 text-sm text-gray-700"> Homepage </a>
                @endauth
            </div>
        @endif
    </div>
</div>
<div class="flex mt-4 sm:items-center sm:justify-center">
